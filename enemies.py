...
class Guardian(Enemy):
    def __init__(self, pos, dimension=(64, 64), entity_id=None):
        ...
        self.diagonal_image = {"bottomleft": pygame.image.load("./data/enemies/01/ds_01.png").convert_alpha(),
                               "bottomright": pygame.transform.flip(
                                   pygame.image.load("./data/enemies/01/ds_01.png").convert_alpha(), True, False),
                               "topright": pygame.image.load("./data/enemies/01/ds_02.png").convert_alpha(),
                               "topleft": pygame.transform.flip(
                                   pygame.image.load("./data/enemies/01/ds_02.png").convert_alpha(), True, False)
                               }
